...
class SaleController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.sales.index',compact(
            'title','products', 'total_quantity', 'total_sales',
        ));
    }
    ...
    public function generateReport(Request $request){
        ...
        $total_quantity = Sale::whereBetween(DB::raw('DATE(created_at)'), [$request->from_date, $request->to_date])
        ->sum('quantity');

    $total_sales = Sale::whereBetween(DB::raw('DATE(created_at)'), [$request->from_date, $request->to_date])
        ->sum('total_price');
        
        return view('admin.sales.reports',compact(
            'sales','title','total_quantity', 'total_sales'
        ));
    }
